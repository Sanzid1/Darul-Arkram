...
$options['crt_manage_hero_v1_section-'.self::$prefix_pre] = array(
    ...
    'control' => array(
        ...
        'crt_manage_enable_hero_v1_is_content' => array(
            'label'    => esc_html__( 'Hero Content', 'crt-manage' ),
            'def' => true,
            'type' => 'toggle_switch',
            'class' => 'Crt_Manage_Toggle_Switch_Custom_Control',
        ),
        'crt_manage_hero_v1_center_post' => array(
            ...
            'active_callback' => 'crt_manage_is_hero_v1_is_not_content',
        ),
        ...
        'crt_manage_hero_v1_content' => array(
            'label'    => esc_html__( 'Content', 'crt-manage' ),
            'type' => 'textarea',
            'active_callback' => 'crt_manage_is_hero_v1_is_content',
        ),
    )
);
