...
function crt_manage_import_files() {
    return [
        [
            'import_file_name'             => 'Market Coupons Deals',
            'categories'                   => [ 'Ecommerce' ],
            'import_file_url'            => 'http://demo1.crthemes.com/data/coupon/content.xml',
            'import_widget_file_url'     => 'http://demo1.crthemes.com/data/coupon/widgets.wie',
            'import_customizer_file_url' => 'http://demo1.crthemes.com/data/coupon/customizer.dat',
