...
function crt_manage_import_files() {
    return [
        [
            'import_file_name'             => 'Nason Magazine Blog',
            'categories'                   => [ 'Blog' ],
            'import_file_url'            => 'http://demo1.crthemes.com/data/nason/content.xml',
            'import_widget_file_url'     => 'http://demo1.crthemes.com/data/nason/widgets.wie',
            'import_customizer_file_url' => 'http://demo1.crthemes.com/data/nason/customizer.dat',
...
function crt_manage_after_import_setup() {
    ...
    crt_manage_update_data('https://demo1.crthemes.com/nason/');
}
