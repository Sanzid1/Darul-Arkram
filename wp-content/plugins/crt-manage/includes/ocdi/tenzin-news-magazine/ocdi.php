...
function crt_manage_import_files() {
    return [
        ...
        [
            ...
            'categories'                   => [ 'Magazine' ],
            'import_file_url'            => 'http://demo1.crthemes.com/data/travel/content.xml',
            'import_widget_file_url'     => 'http://demo1.crthemes.com/data/travel/widgets.wie',
            'import_customizer_file_url' => 'http://demo1.crthemes.com/data/travel/customizer.dat',
