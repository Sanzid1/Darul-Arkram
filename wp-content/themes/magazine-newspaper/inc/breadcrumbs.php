...
class Breadcrumb_Trail {
	...
	protected function set_labels() {
		...
		$defaults = array(
			...
			'home'                => esc_html__( 'Home',                                  'default' ),
			'error_404'           => esc_html__( 'Page: 404',                         		'default' ),
			'archives'            => esc_html__( 'Archives',                              'default' ),
			// Translators: %s is the search query.
			'search'              => esc_html__( 'Search results for: "%s"',              'default' ),
			// Translators: %s is the page number.
			'paged'               => esc_html__( 'Page %s',                               'default' ),
			// Translators: %s is the page number.
			'paged_comments'      => esc_html__( 'Page %s',                       				'default' ),
