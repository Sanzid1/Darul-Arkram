                            ...
                            <div class="footer__social">
                                ...
                                <ul>
                                    <?php foreach ( $footer_socials as $item ): ?>
                                        <li class="li-<?php echo esc_attr($item['icon_value']) ?>"> <a style="" class="" href="<?php echo esc_attr($item['link']) ?>" target="_blank" rel="alternate" title="<?php echo esc_attr($item['icon_value']) ?>"> <i class="fa-brands <?php echo esc_attr($item['icon_value']) ?>"></i></a></li>
                                    <?php endforeach; ?>
                                </ul>
                                <?php endif; ?>
                            </div>
