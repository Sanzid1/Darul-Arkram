...
function tenzin_news_magazine_scripts() {
    ...
    // Main script.
    wp_enqueue_script( 'tenzin-news-magazine-owl-script', get_template_directory_uri() . '/assets/js/owl.carousel.min.js', array(), TENZIN_NEWS_MAGAZINE_VERSION, true );
    wp_enqueue_script( 'tenzin-news-magazine-modernizr-script', get_template_directory_uri() . '/assets/js/modernizr-3.11.2.min.js', array(), TENZIN_NEWS_MAGAZINE_VERSION, true );
    wp_enqueue_script( 'tenzin-news-magazine-imagesloaded-script', get_template_directory_uri() . '/assets/js/imagesloaded.pkgd.js', array(), TENZIN_NEWS_MAGAZINE_VERSION, true );
    wp_enqueue_script( 'tenzin-news-magazine-masonry-script', get_template_directory_uri() . '/assets/js/masonry.pkgd.min.js', array( 'jquery' ), TENZIN_NEWS_MAGAZINE_VERSION, true );
    wp_enqueue_script( 'tenzin-news-magazine-sticky-script', get_template_directory_uri() . '/assets/js/theia-sticky-sidebar.min.js', array(), TENZIN_NEWS_MAGAZINE_VERSION, true );
    wp_enqueue_script( 'tenzin-news-magazine-resize-script', get_template_directory_uri() . '/assets/js/resize-sensor.min.js', array(), TENZIN_NEWS_MAGAZINE_VERSION, true );
    wp_enqueue_script( 'tenzin-news-magazine-lazy-script', get_template_directory_uri() . '/assets/js/jquery.lazy.min.js', array(), TENZIN_NEWS_MAGAZINE_VERSION, true );
